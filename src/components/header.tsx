...
export default function Header() {
	...
	return (
		<header>
			<nav className="shadow-sm flex-wrap border-b-2 border-zinc-400 flex flex-row justify-center align-center items-center gap-x-4 sm:gap-x-8 md:gap-x-16 lg:gap-x-32 p-2">
